...
///
/// Macro pour récupérer une couleur d'un QColorDialog dans un bouton CustomPushButton
/// a : CustomPushButton
/// b : QLineEdit
///
#define MACRO_COLOR(a,b) QColor lCOLOR = QColorDialog::getColor(a->getColor(), this );if( lCOLOR.isValid()){a->setColor(lCOLOR); b->setText(lCOLOR.name().toUpper());};

///
///  Macro pour coloriser un CustomPushButton avec la couleur QLineEdit au format HTML #RRGGBB
/// a : QLineEdit
/// b : CustomPushButton
///
#define COLORfromTEXT(a,b) if (a->text().length() == 7) b->setColor(QColor(a->text().mid(1,2).toInt(nullptr,16),a->text().mid(3,2).toInt(nullptr,16),a->text().mid(5,2).toInt(nullptr,16)));
...
///
/// \brief MainWindow::on_Folioter_Btn_EtapeSuivante1_clicked
/// Passage à l'étape suivante
///
void MainWindow::on_Folioter_Btn_EtapeSuivante1_clicked()
{
    ...
    if ((ui->Folioter_Txt_NomDuSite->text().length()>0) && (ui->Folioter_Txt_RefREE->text().length()>0) && (ui->Folioter_Txt_IndiceREE->text().length()>0))
    {
...
///
/// \brief MainWindow::on_Folioter_Txt_NomDuSite_textChanged
/// Permet de faire apparaitre le bouton d'étape suivante
/// \param arg1
///
void MainWindow::on_Folioter_Txt_NomDuSite_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)
...
///
/// \brief MainWindow::on_Folioter_Txt_RefREE_textChanged
/// Permet de faire apparaitre le bouton d'étape suivante
/// \param arg1
///
void MainWindow::on_Folioter_Txt_RefREE_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)
    if ((ui->Folioter_Txt_NomDuSite->text() != "") && (ui->Folioter_Txt_RefREE->text()) != "" && (ui->Folioter_Txt_IndiceREE->text() != ""))
        ui->Folioter_Btn_EtapeSuivante2->setEnabled(true);
...
///
/// \brief MainWindow::on_Folioter_Txt_IndiceREE_textChanged
/// Permet de faire apparaitre le bouton d'étape suivante
/// \param arg1
///
void MainWindow::on_Folioter_Txt_IndiceREE_textChanged(const QString &arg1)
{
    Q_UNUSED(arg1)
    if ((ui->Folioter_Txt_NomDuSite->text() != "") && (ui->Folioter_Txt_RefREE->text()) != "" && (ui->Folioter_Txt_IndiceREE->text() != ""))
        ui->Folioter_Btn_EtapeSuivante2->setEnabled(true);
...
///
/// \brief MainWindow::on_Folioter_Btn_EtapeSuivante2_clicked
/// Passage à l'étape suivante
///
void MainWindow::on_Folioter_Btn_EtapeSuivante2_clicked()
{
...
///
/// \brief MainWindow::on_Folioter_Btn_EtapeSuivante3_clicked
/// Passage à l'étape suivante
///
void MainWindow::on_Folioter_Btn_EtapeSuivante3_clicked()
{
...
///
/// \brief MainWindow::on_Folioter_Btn_EtapeSuivante4_clicked
/// Passage à l'étape suivante
///
void MainWindow::on_Folioter_Btn_EtapeSuivante4_clicked()
{
    ...
    {
        int NbCheck = 0;
        if (ui->Folioter_Check_Tranche0->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche1->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche2->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche3->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche4->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche5->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche6->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche7->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche8->isChecked()) NbCheck++;
        if (ui->Folioter_Check_Tranche9->isChecked()) NbCheck++;
        if (NbCheck > 0)
        {
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche1_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche1_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche1->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche3_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche3_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche3->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche5_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche5_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche5->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche2_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche2_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche2->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche4_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche4_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche4->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche6_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche6_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche6->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche0_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche0_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche0->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche9_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche9_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche9->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche8_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche8_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche8->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Check_Tranche7_toggled
/// Permet de faire apparaitre / disparaitre le démarrage du foliotage
/// \param checked
///
void MainWindow::on_Folioter_Check_Tranche7_toggled(bool checked)
{
    ui->Folioter_Texte_Tranche7->setEnabled(checked);
    {
        ui->Folioter_Group_ChoixTranche->setEnabled(true);
        ui->Folioter_Group_ChoixTranche->setVisible(true);
        ui->Folioter_Group_Annuler->setEnabled(false);
...
///
/// \brief MainWindow::on_Folioter_Btn_ChoixFolioAnnuler_clicked
/// Permet de faire apparaitre l'onglet de choix de folio à annuler
///
void MainWindow::on_Folioter_Btn_ChoixFolioAnnuler_clicked()
{
...
///
/// \brief MainWindow::on_Annulation_Btn_Valider_clicked
/// Validation des folios à annuler
///
void MainWindow::on_Annulation_Btn_Valider_clicked()
{
    ui->tabWidget->setTabVisible(0,true);
    ui->tabWidget->setTabVisible(1,false);
    ui->tabWidget->setTabVisible(2,true);
    ...
    ui->tabWidget->setCurrentIndex(0);
    QDir directory(QFileInfo(CheminTemp).filePath());
    QStringList images = directory.entryList(QStringList() << "_64_*.png" << "_HR_*.png",QDir::Files, QDir::Name | QDir::IgnoreCase);
    foreach(QString filename, images) {
        directory.remove(filename);
    }
    int NombreAnnule = 0;
    for (int var = 0; var < ui->Annulation_Liste->rowCount(); ++var) {
        ...
        vecFolioAnnuler[var + (ui->Folioter_Radio_FolioPartiel->isChecked()?ui->Folioter_Spin_Partiel_Debut->value()-1:0)] = mCheck->isChecked();
        if (mCheck->isChecked())
            NombreAnnule++;
    }
...
///
/// \brief MainWindow::on_Annulation_Btn_NePasAnnuler_clicked
/// Fermeture de la fenêtre de choix de folio ) annuler sans aucun choix
///
void MainWindow::on_Annulation_Btn_NePasAnnuler_clicked()
{
    ui->tabWidget->setTabVisible(0,true);
    ui->tabWidget->setTabVisible(1,false);
    ui->tabWidget->setTabVisible(2,true);
...
///
/// \brief MainWindow::on_Annulation_Liste_cellClicked
/// Permet de charger une miniature de meilleur qualité quand une ligne est cliquée
/// \param row
/// \param column
///
void MainWindow::on_Annulation_Liste_cellClicked(int row, int column)
{
    Q_UNUSED(column);
...
///
/// \brief MainWindow::on_Annulation_Bouton_Tout_clicked
/// Sélectionne la totalité des checkbox des folios annulables
///
void MainWindow::on_Annulation_Bouton_Tout_clicked()
{
    for (int var = 0; var < ui->Annulation_Liste->rowCount(); ++var) {
        QCheckBox* mCheck = qobject_cast<QCheckBox*>(ui->Annulation_Liste->cellWidget(var,0));
...
///
/// \brief MainWindow::on_Annulation_Bouton_Rien_clicked
/// Désélectionne toutes les checkbox des folios annulables
///
void MainWindow::on_Annulation_Bouton_Rien_clicked()
{
    for (int var = 0; var < ui->Annulation_Liste->rowCount(); ++var) {
        QCheckBox* mCheck = qobject_cast<QCheckBox*>(ui->Annulation_Liste->cellWidget(var,0));
...
///
/// \brief MainWindow::on_Folioter_Radio_FolioTotal_toggled
/// Logique de choix entre foliotage total et partiel
/// \param checked
///
void MainWindow::on_Folioter_Radio_FolioTotal_toggled(bool checked)
{
    Q_UNUSED(checked);
...
///
/// \brief MainWindow::on_Folioter_Radio_FolioPartiel_toggled
/// Logique de choix entre foliotage total et partiel
/// \param checked
///
void MainWindow::on_Folioter_Radio_FolioPartiel_toggled(bool checked)
{
    Q_UNUSED(checked);
...
///
/// \brief MainWindow::on_Folioter_Btn_FoliotageSansPDG_clicked
/// Lance l'opération de foliotage avec les différents paramètres
/// Cette fonction peut aussi être appelé avec le Flag AjoutPDG pour insérer la page de garde
///
void MainWindow::on_Folioter_Btn_FoliotageSansPDG_clicked()
{
    ...
    QThread* thread = QThread::create([&]
    {
        ...
        for (int t = 0; t < 10; ++t) {
            ...
            if ((t == 0) && (!ui->Folioter_Check_Tranche0->isChecked()))    continue;
            if ((t == 1) && (!ui->Folioter_Check_Tranche1->isChecked()))    continue;
            if ((t == 2) && (!ui->Folioter_Check_Tranche2->isChecked()))    continue;
            if ((t == 3) && (!ui->Folioter_Check_Tranche3->isChecked()))    continue;
            if ((t == 4) && (!ui->Folioter_Check_Tranche4->isChecked()))    continue;
            if ((t == 5) && (!ui->Folioter_Check_Tranche5->isChecked()))    continue;
            if ((t == 6) && (!ui->Folioter_Check_Tranche6->isChecked()))    continue;
            if ((t == 7) && (!ui->Folioter_Check_Tranche7->isChecked()))    continue;
            if ((t == 8) && (!ui->Folioter_Check_Tranche8->isChecked()))    continue;
            if ((t == 9) && (!ui->Folioter_Check_Tranche9->isChecked()))    continue;
            try
            {
                QString PDFSortieTranche = QFileInfo(PDFASauver).path() + "/" + QFileInfo(PDFASauver).baseName() + "_TR" + QString::number(t) + ".pdf";
                PoDoFo::PdfMemDocument document(PDFOuvert.toStdWString().c_str());
                PoDoFo::PdfFont* pFont = document.CreateFontSubset("Roboto", true, false, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(),QDir::toNativeSeparators(TempTamponRoboto).toStdString().c_str());
                ...
                for (qint64 i = mStarting; i < mEnding; i++)
                {
                    ...
                    PoDoFo::PdfPage* pPage = document.GetPage(i);
                    {
                        if (vecFolioAnnuler[i])
                        {
                            ...
                            PoDoFo::PdfString TexteFolioAnnulee(reinterpret_cast<const PoDoFo::pdf_utf8*>(
                                                                    ui->OPT_Text_FolioAnnule->text().toUtf8().constData()));
                            if (vecRotation[i] == 0)
                            {
                    ...
                    {//Début des tampons
                        ...
                        painter.SetStrokingColor(MACRO_COLORtoDOUBLE(CouleurTranche,t));//Couleur ligne format RGB avec 0 à 255 = 0.0 à 1.0
                        ...
                        painter.SetColor(MACRO_COLORtoDOUBLE(CouleurTranche,t));//Couleur texte format RGB avec 0 à 255 = 0.0 à 1.0
                        PoDoFo::PdfString utf8SiteDe(reinterpret_cast<const PoDoFo::pdf_utf8*>(
                                                         QString("Site de " + ui->Folioter_Txt_NomDuSite->text()).toStdString().c_str()));
                        PoDoFo::PdfString utf8Tranche(reinterpret_cast<const PoDoFo::pdf_utf8*>(
                                                          QString("Tr. " + QString::number(t)).toStdString().c_str()));
                        PoDoFo::PdfString utf8REE(reinterpret_cast<const PoDoFo::pdf_utf8*>(
                                                      ui->Folioter_Txt_RefREE->text().toStdString().c_str()));
                        PoDoFo::PdfString utf8Indice(reinterpret_cast<const PoDoFo::pdf_utf8*>(
                                                         QString("Ind. " + ui->Folioter_Txt_IndiceREE->text()).toStdString().c_str()));
                        PoDoFo::PdfString utf8Folio(reinterpret_cast<const PoDoFo::pdf_utf8*>(
                                                        QString("Folio " + QString::number(ui->Folioter_Spin_PremierePage->value() + i - (ui->Folioter_Radio_FolioPartiel->isChecked()? ui->Folioter_Spin_Partiel_Debut->value() - 1 : 0))).toStdString().c_str()));
                        PoDoFo::PdfString utf8Cycle(reinterpret_cast<const PoDoFo::pdf_utf8*>(
                                                        QString("Cycle " + QString::number(t) + CodeTranche[t]).toStdString().c_str()));
                        ...
                        else if (ui->OPT_Radio_HD->isChecked())
                        {//Haut Droite
                            if (vecRotation[i] == 0)
                            {
                                rect.SetLeft(vecMediaBox[i].GetWidth() - rect.GetWidth() - (double)ui->OPT_Spin_Largeur->value());
                        ...
                        else if (ui->OPT_Radio_BG->isChecked())
                        {//Bas Gauche
                            if (vecRotation[i] == 0)
                            {
                                rect.SetLeft(0.0 + (double)ui->OPT_Spin_Largeur->value());
                        ...
                        else if (ui->OPT_Radio_BD->isChecked())
                        {//Bas Droite
                            if (vecRotation[i] == 0)
                            {
                                rect.SetLeft(vecMediaBox[i].GetWidth() - rect.GetWidth() - (double)ui->OPT_Spin_Largeur->value());
...
///
/// \brief MainWindow::on_Folioter_Btn_FoliotageAvecPDG_clicked
/// Mets en place les variables afin de réaliser un foliotage avec une page de garde
///
void MainWindow::on_Folioter_Btn_FoliotageAvecPDG_clicked()
{
    ModeAjoutPDG = true;
...
///
/// \brief MainWindow::on_PDG_Btn_GenerePDF_clicked
/// Génération manuelle de la page de garde uniquement
///
void MainWindow::on_PDG_Btn_GenerePDF_clicked()
{
    ...
    if (ui->PDG_ListeWidget->count() > 0)
    {
        ...
        {
            QMessageBox::warning(this, "REEMaker - Erreur","Tout les champs obligatoires ne sont pas renseignés.\nNombre de champs à renseigner pour continuer : " + QString::number(NombreNonRemplis));
    ...
    QLabel *Label0 = new QLabel("Séléctionner les tranches concernées et renseigner les informations suivantes :");
    ...
    {
        if (mTrancheCB0->isChecked()) Tranche.append(0);
        if (mTrancheCB1->isChecked()) Tranche.append(1);
        if (mTrancheCB2->isChecked()) Tranche.append(2);
        if (mTrancheCB3->isChecked()) Tranche.append(3);
        if (mTrancheCB4->isChecked()) Tranche.append(4);
        if (mTrancheCB5->isChecked()) Tranche.append(5);
        if (mTrancheCB6->isChecked()) Tranche.append(6);
        if (mTrancheCB7->isChecked()) Tranche.append(7);
        if (mTrancheCB8->isChecked()) Tranche.append(8);
        if (mTrancheCB9->isChecked()) Tranche.append(9);
        if (Tranche.count() == 0)
        {
            QMessageBox::information(this, "REEMaker - Erreur","Aucune tranche n'a été sélectionnée, abandon de l'opération");
            return;
        }
        ...
        {
            QMessageBox::information(this, "REEMaker - Erreur","Nom du site, Référence du REE et Indice requis pour continuer, abandon de l'opération");
            return;
        }
...
/// \return
///
QString MainWindow::GetVersion(QString fName)
{
    QString Result = "";
                ...
                if (size)
                {
                    ...
                    if (verInfo->dwSignature == 0xfeef04bd)
                        Result = QString("%1.%2.%3.%4").arg(
                                    QString::number((verInfo->dwFileVersionMS >> 16 ) & 0xff),
...
///
/// \brief MainWindow::ChargerPageDeGarde
/// Charge une page de garde pour réaliser le foliotage d'un REE
/// \param Nom
/// \param Chemin
/// \return
///
bool MainWindow::ChargerPageDeGarde(QString Nom, QString Chemin)
{
...
///
/// \brief MainWindow::on_PDG_Btn_SauvegardePDGutilisateur_clicked
/// Permet de sauvegarder sur disque dans le dossier utilisateur la pagede garde actuelle
///
void MainWindow::on_PDG_Btn_SauvegardePDGutilisateur_clicked()
{
    if (ui->PDG_ListeWidget->count() == 0)
    {
    ...
    bool ok;
    QString NomUtilisateur = QInputDialog::getText(this, "Enregistrement page de garde",
                                                   "Saisir un nom pour la page de garde :", QLineEdit::Normal,
                                                   "", &ok);
    if (ok && !NomUtilisateur.isEmpty())
    {
        ...
        //On rafraichit la liste :
        {
            ...
            if (DefautIndex != -1)
            {
                ...
                ui->PDG_Texte_PDGEnCours->setText(QString("' %1 '   [Page de garde utilisateur]").arg(ui->PDG_Combo_Utilisateur->itemText(DefautIndex)));
...
///
/// \brief MainWindow::on_PDG_Combo_Integre_activated
/// Charge la page de garde dans le dossier intégré
/// \param index
///
void MainWindow::on_PDG_Combo_Integre_activated(int index)
{
...
///
/// \brief MainWindow::on_PDG_Combo_Utilisateur_activated
/// Charge la page de garde dans le dossier utilisateur
/// \param index
///
void MainWindow::on_PDG_Combo_Utilisateur_activated(int index)
{
...
///
void MainWindow::on_EDIT_Bouton_OuvrirPDG_clicked()
{
    PDGOuvertePourEdition = QFileDialog::getOpenFileName(this, "Ouvrir un fichier page de garde",CheminPDGBase,"Fichier TXT (*.txt)",nullptr,QFileDialog::HideNameFilterDetails);
...
///
/// \brief MainWindow::on_EDIT_Bouton_NouvellePDG_clicked
/// Réinitialise le contenu de la liste de bloc de page de garde
///
void MainWindow::on_EDIT_Bouton_NouvellePDG_clicked()
{
...
///
/// \brief MainWindow::on_EDIT_Bouton_EnregistrePDG_clicked
/// Ecrase la page de garde ouverte avec les nouvelles informations
///
void MainWindow::on_EDIT_Bouton_EnregistrePDG_clicked()
{
    if (PDGOuvertePourEdition == "")
...
///
/// \brief MainWindow::on_EDIT_Bouton_EnregistrePDGSous_clicked
/// Enregistre la page de garde sous le chemin désiré
///
void MainWindow::on_EDIT_Bouton_EnregistrePDGSous_clicked()
{
...
///
/// \brief MainWindow::RetourneIndexLibre
/// Retourne le prochain numéro d index libre
/// \return
///
qint64 MainWindow::RetourneIndexLibre()
{
...
///
/// \brief MainWindow::on_EDIT_Bouton_Ligne_clicked
/// Ajoute un controle DessineTexte
///
void MainWindow::on_EDIT_Bouton_Ligne_clicked()
{
...
/// Ajoute un controle DessineRectanleVide
///
void MainWindow::on_EDIT_Bouton_RectVide_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_RectGrille_clicked
/// Ajoute un controle DessineRectanleGrille
///
void MainWindow::on_EDIT_Bouton_RectGrille_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_RectRemplis_clicked
/// Ajoute un controle DessineRectanleRemplis
///
void MainWindow::on_EDIT_Bouton_RectRemplis_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_Texte_clicked
/// Ajoute un controle DessineTexte
///
void MainWindow::on_EDIT_Bouton_Texte_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_TexteMulti_clicked
/// Ajoute un controle DessineTexteMulti
///
void MainWindow::on_EDIT_Bouton_TexteMulti_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_TexteQuestion_clicked
/// Ajoute un controle DessineTexteQuestion
///
void MainWindow::on_EDIT_Bouton_TexteQuestion_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_TexteMultiQuestion_clicked
/// Ajoute un controle DessineTexteMultiligne
///
void MainWindow::on_EDIT_Bouton_TexteMultiQuestion_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_Checkbox_clicked
/// Ajoute un controle DessineRectanleVide
///
void MainWindow::on_EDIT_Bouton_Checkbox_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_CheckboxQeustion_clicked
/// Ajoute un controle DessineCheckBoxQuestion
///
void MainWindow::on_EDIT_Bouton_CheckboxQeustion_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_MultiCheckboxQuestion_clicked
/// Ajoute un controle DessineMultiCheckBoxQuestion
///
void MainWindow::on_EDIT_Bouton_MultiCheckboxQuestion_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_InsereImage_clicked
/// Ajoute un controle InsereImage
///
void MainWindow::on_EDIT_Bouton_InsereImage_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_PageSuivante_clicked
/// Ajoute un controle PageSuivante
///
void MainWindow::on_EDIT_Bouton_PageSuivante_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
///
/// \brief MainWindow::on_EDIT_Bouton_Commentaire_clicked
/// Ajoute un controle Commentaire
///
void MainWindow::on_EDIT_Bouton_Commentaire_clicked()
{
    Bloc::ItemDefinition StructBloc = Bloc::ItemDefinition();
...
/// Fait apparaitre un picker de couleur
///
void MainWindow::on_Edit_Bouton_OutilCouleur_clicked()
{
    MemColor = QColorDialog::getColor(MemColor, this );
}

///
/// \brief MainWindow::GetNumArg
/// Récupère le nombre d'argument
/// \param lVecList
/// \param indexDepart
/// \return
///
int MainWindow::GetNumArg(QVector<QString> &lVecList, int indexDepart)
{
    int nbArg = 0;
...
///
/// \brief MainWindow::GetNumCOMM
/// Récupère le nombre commentaire
/// \param lVecList
/// \param indexDepart
/// \return
///
int MainWindow::GetNumCOMM(QVector<QString> &lVecList, int indexDepart)
{
    int nbArg = 0;
    for (qsizetype i = indexDepart; i < lVecList.size(); i++)
    {
...
///
/// \brief MainWindow::RetourneCleStr
...
/// \return
///
QString MainWindow::RetourneCleStr(QVector<QString>& lVecKey, QString Cle, QString Defaut)
{
...
///
/// \brief MainWindow::RetourneCleDouble
...
/// \return
///
double MainWindow::RetourneCleDouble(QVector<QString>& lVecKey, QString Cle, double Defaut)
{
    for (qsizetype i = 0; i < lVecKey.size(); i++)
    {
        if (lVecKey[i].length() < Cle.length() + 2 /*--*/)
...
///
/// \brief MainWindow::RetourneCleInt
...
/// \return
///
int MainWindow::RetourneCleInt(QVector<QString>& lVecKey, QString Cle, int Defaut)
{
    for (qsizetype i = 0; i < lVecKey.size(); i++)
    {
        if (lVecKey[i].length() < Cle.length() + 2 /*--*/)
...
///
/// \brief MainWindow::RetourneCleBool
...
/// \return
///
bool MainWindow::RetourneCleBool(QVector<QString>& lVecKey, QString Cle, bool Defaut)
{
    for (qsizetype i = 0; i < lVecKey.size(); i++)
    {
        if (lVecKey[i].length() < Cle.length() + 2 /*--*/)
...
///
/// \brief MainWindow::ChargePDG
/// Charge le contenu d'une page de garde en mémoire
/// \param CheminPDG
/// \return
///
bool MainWindow::ChargePDG(QString CheminPDG)
{
    ...
    for (qsizetype compteLigne = 0; compteLigne < vecFichierPDG.size(); compteLigne++)
    {
        ...
        if (tLine == "DESSINELIGNE")
        {
            ...
            mActBtn.Couleur = QString("#%1%2%3").arg(QString("%1").arg(RetourneCleInt(cpVec, "rouge",0), 2, 16, QLatin1Char( '0' )),QString("%1").arg(RetourneCleInt(cpVec, "vert",0), 2, 16, QLatin1Char( '0' )),QString("%1").arg(RetourneCleInt(cpVec, "bleu",0), 2, 16, QLatin1Char( '0' )));
        ...
        else if (tLine == "DESSINERECTANGLEVIDE")
        {
            ...
            int nbARG = GetNumArg(vecFichierPDG, compteLigne + 1);
            QVector<QString> cpVec = vecFichierPDG.mid(compteLigne + 1,nbARG);
            //            cpVec.insert(cpVec.begin(), vecFichierPDG.begin() + compteLigne + 1, vecFichierPDG.begin() + compteLigne + 1 + nbARG);
            mActBtn.DebutX = RetourneCleDouble(cpVec, "debutx",0.0);
            mActBtn.DebutY = RetourneCleDouble(cpVec, "debuty",0.0);
        ...
        else if (tLine == "DESSINERECTANGLEREMPLIS")
        {
            ...
            if (RetourneCleInt(cpVec, "rouge",0) == -2)
                mActBtn.Couleur = "{ACC 2}";
            mActBtn.CouleurRemplissage = QString("#%1%2%3").arg(QString("%1").arg(RetourneCleInt(cpVec, "remplisrouge",0), 2, 16, QLatin1Char( '0' )),QString("%1").arg(RetourneCleInt(cpVec, "remplisvert",0), 2, 16, QLatin1Char( '0' )),QString("%1").arg(RetourneCleInt(cpVec, "remplisbleu",0), 2, 16, QLatin1Char( '0' )));
...
///
/// \brief MainWindow::SauvePDG
/// Sauvegarde la page de garde actuelle sur disque
/// \param FichierSortie
/// \return
///
bool MainWindow::SauvePDG(QString FichierSortie)
{
    if (ui->EDIT_Liste->count() == 0)
    {
        return false;
...
///
/// \brief MainWindow::on_APROPOS_Texte_anchorClicked
...
///
/// \brief MainWindow::on_APROPOS_Texte_highlighted
/// Affiche dans la status bar l'URL
/// \param arg1
///
void MainWindow::on_APROPOS_Texte_highlighted(const QUrl &arg1)
{
    ui->statusbar->showMessage(arg1.toDisplayString(QUrl::None),2000);
}

///
/// \brief MainWindow::RepareGhostScript
...
/// \return
///
MainWindow::ValeurRetour MainWindow::RepareGhostScript(QString FichierSource, qint16 ValeurMax, bool Downsample)
{
    ...
    QString FichierBKUP = QFileInfo(FichierSource).path() + "/" + QFileInfo(FichierSource).baseName() + "_backup" + QDateTime::currentDateTime().toString("_ddMMyy_hhmmss") + ".pdf";
...
///
/// \brief MainWindow::PDFInfoNombrePage
/// Utilise PDFInfo pour récupérer le nombre de pages dans un fichier PDF en partant du principe qu'il est corrompu et que PoDoFo ne peut l'ouvrir
/// \param FichierSource
/// \return
///
...
///
/// \brief MainWindow::CheckIntegrite
/// Contrôle l'intégrité des fichiers nécessaires au fonctionnement de REEMaker
/// \return
///
bool MainWindow::CheckIntegrite()
{
    // Notification de fichier manquant
    QStringList FichierAchercher =
    {
        "libasprintf-0.dll",
        "libatomic-1.dll",
        "libbrotlicommon.dll",
...
///
/// \brief MainWindow::AfficheEditeurPDG
/// Action pour afficher / masquer l'éditeur de page de garde
///
void MainWindow::AfficheEditeurPDG()
{
    if (ui->tabWidget->currentIndex() == 1)
        return;//On est en plein processus de PDG
    if (savState.ModeEditeur)
    {//On est en mode éditeur
        ui->tabWidget->setTabVisible(0,true);
        ui->tabWidget->setTabVisible(2,true);
        ui->tabWidget->setTabVisible(3,true);
...
///
/// \brief MainWindow::AfficheAide
/// Action poru afficher l'aide de REEMaker
///
void MainWindow::AfficheAide()
{
    QDesktopServices::openUrl(QUrl::fromLocalFile(QCoreApplication::applicationDirPath() + "/REEMakerAide.pdf"));
}

///
/// \brief MainWindow::on_actionBasculer_entre_le_mode_clair_sombre_triggered
/// Permet la bascule entre le mode clair et sombre, propose un redémarrage de l'application
///
void MainWindow::BasculerClairSombre()
{
    ...
    QAbstractButton* pButtonClair = mBox.addButton(QString(" Appliquer le mode clair%1").arg(ThemeDark?"\n (Redémarrage de REEMaker obligatoire)":""), QMessageBox::YesRole);
    QAbstractButton* pButtonSombre = mBox.addButton(QString(" Appliquer le mode sombre%1").arg(!ThemeDark?"\n (Redémarrage de REEMaker obligatoire)":""), QMessageBox::NoRole);
    ...
    pButtonClair->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred) ;
    pButtonSombre->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred) ;
    pButtonAnnuler->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred) ;
    mBox.exec();
    if (ThemeDark)
...
void MainWindow::on_PDG_Btn_SupprimePDGUtilisateur_clicked()
{
    ...
    QMessageBox mBox;
    mBox.setWindowTitle(QString("Suppression d'une page de garde utilisateur"));
    mBox.setWindowIcon(this->windowIcon());
    mBox.setText(QString("Voulez-vous supprimer la page de garde '%1' ?").arg(ui->PDG_Combo_Utilisateur->currentText()));
    QAbstractButton* pButtonOK = mBox.addButton("Effacer", QMessageBox::YesRole);
    QAbstractButton* pButtonAnnuler = mBox.addButton("Annuler", QMessageBox::NoRole);
    mBox.exec();
    if(mBox.clickedButton() == pButtonAnnuler)
    {
        return;
