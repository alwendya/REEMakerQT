...
///
/// \brief PDGHelper::PDGHelper Initialisation de l'aide de page de garde
///
PDGHelper::PDGHelper()
{
}
...
///
/// \brief PDGHelper::~PDGHelper    Déchargement de l'aide de page de garde
///
PDGHelper::~PDGHelper()
{
}
///
/// \brief PDGHelper::SetBaseModelePath     Met en mémoire le dossier contenant la page de garde
/// \param lBaseModelePath      Dossier
///
...
///
/// \brief PDGHelper::OpenAndParseConfig_v2     Ouvre et parse le contenu d'un fichier Page de garde
/// \param CheminConfig     Nom du fichier
/// \return
///
bool PDGHelper::OpenAndParseConfig_v2(QString CheminConfig)
{
    ...
    for (qsizetype compteLigne = 0; compteLigne < vecFichierPDG.size(); compteLigne++)
    {
        ...
        if (trimmedLine.mid(0, 2) != "--")//C'est pas un argument, on push le vec precedent puis on re-on init mVecCommande avec la fonction
        {
...
///
/// \brief PDGHelper::BurstVersDisque       Décharge dans un fichier texte le contenu de l'aide de page de garde
...
bool PDGHelper::BurstVersDisque(QString FichierSortie)
{
    ...
    for (qsizetype lArg = 0; lArg < vecCommandeList.size(); lArg++)
    {
        ...
        for (qsizetype i = 0; i < vecCommandeList[lArg].mVecCommande.size(); i++)
        {
            ...
            if (wKeys == "debutx" || wKeys == "debuty" || wKeys == "finx" || wKeys == "finy"
                    || wKeys == "rouge" || wKeys == "vert" || wKeys == "bleu"
                    || wKeys == "epaisseur" || wKeys == "largeur" || wKeys == "hauteur"
                    || wKeys == "nombrecolonne" || wKeys == "nombreligne"
                    || wKeys == "remplisrouge" || wKeys == "remplisvert" || wKeys == "remplisbleu"
                    || wKeys == "alignlargeur" || wKeys == "alignhauteur" || wKeys == "taillepolice"
                    || wKeys == "split" || wKeys == "max" || wKeys == "debutx1"
                    || wKeys == "debutx2" || wKeys == "debuty1" || wKeys == "debuty2"
                    )
                f_out << "--" << wKeys << "=" << wValeur << Qt::endl;
            //Cles sans valeur ==> FLAG
            else if (wKeys == "gras" || wKeys == "grasitalic" || wKeys == "italic" || wKeys == "monospace"
                     || wKeys == "obligatoire" || wKeys == "majuscule" || wKeys == "minuscule" || wKeys == "chiffre")
                f_out << "--" << wKeys << Qt::endl;
            //Cles avec string
...
///
/// \brief PDGHelper::DrawOnPage_v2     Permet de dessiner la page de garde sur un document PoDoFo existant
/// \param Painter      Painter utilisé par PoDoFo
/// \param Document     Document PoDoFo
/// \return
///
int PDGHelper::DrawOnPage_v2(PoDoFo::PdfPainter& Painter, PoDoFo::PdfDocument& Document)
{
    ...
    /*
    * ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    * ░▒▓   Chemin de base de l'executable, fini pas par \   ▓▒░
    * ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░
    */
    QString CheminBASE = QCoreApplication::applicationDirPath() + "/";
    ...
    */
    PoDoFo::PdfFont* pFontMono = Document.CreateFontSubset("Roboto Mono", false, false, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoMonoRegular.toStdString().c_str());
    PoDoFo::PdfFont* pFontMonoBOLD = Document.CreateFontSubset("Roboto Mono Bold", true, false, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoMonoBold.toStdString().c_str());
    PoDoFo::PdfFont* pFontMonoITALIC = Document.CreateFontSubset("Roboto Mono Italic", false, true, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoMonoItalic.toStdString().c_str());
    PoDoFo::PdfFont* pFontMonoBOLDITALIC = Document.CreateFontSubset("Roboto Mono Bold Italic", true, true, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoMonoBoldItalic.toStdString().c_str());
    PoDoFo::PdfFont* pFontReg = Document.CreateFontSubset("Roboto", false, false, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoRegular.toStdString().c_str());
    PoDoFo::PdfFont* pFontRegBOLD = Document.CreateFontSubset("Roboto Bold", true, false, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoBold.toStdString().c_str());
    PoDoFo::PdfFont* pFontRegITALIC = Document.CreateFontSubset("Roboto Italic", false, true, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoItalic.toStdString().c_str());
    PoDoFo::PdfFont* pFontRegBOLDITALIC = Document.CreateFontSubset("Roboto Bold Italic", true, true, false, PoDoFo::PdfEncodingFactory::GlobalWinAnsiEncodingInstance(), CheminRobotoBoldItalic.toStdString().c_str());
    if (pFontMono == NULL || pFontMonoBOLD == NULL || pFontMonoBOLDITALIC == NULL || pFontMonoITALIC == NULL)
    {
        qDebug() << L"ERROR: Les font Monospace n'ont pu être chargées";
        return 0;
    }
    if (pFontReg == NULL || pFontRegBOLD == NULL || pFontRegBOLDITALIC == NULL || pFontRegITALIC == NULL)
    {
        qDebug() << "ERROR: Les font Regular n'ont pu être chargées";
        return 0;
    }
        ...
        {
            {
                ...
                if (ValSplit < 2)
                {
                    ...
                    Painter.DrawMultiLineText(PoDoFo::PdfRect(valDebutX, PageHeight - valDebutY - valHauteur, valLargeur, valHauteur), mUtf8, mAlignLargeur, mAlignHauteur, false);
                }
                else
                {
                    //                    QVector<QChar> _vChar; _vChar.resize(ValSplit);
                    ...
                    for (qsizetype i = 0; i < ValSplit; i++)
                    {
                        ...
                        Painter.DrawMultiLineText(PoDoFo::PdfRect(valDebutX + (i * _gap), PageHeight - valDebutY - valHauteur, _gap, valHauteur), mUtf8, mAlignLargeur, mAlignHauteur, false);
                    }
                }
                qDebug() << " effectué";
            }
        ...
        {
            {
                ...
                Painter.SetColor((double)(ValRouge / 255.0), (double)(valVert / 255.0), (double)(valBleu / 255.0));//Couleur ligne
                PoDoFo::PdfString mUtf8(reinterpret_cast<const PoDoFo::pdf_utf8*>(valTexte.toUtf8().constData()));
                Painter.DrawMultiLineText(PoDoFo::PdfRect(valDebutX, PageHeight - valDebutY - valHauteur, valLargeur, valHauteur), mUtf8, mAlignLargeur, mAlignHauteur);
                qDebug() << " effectué";
            }
        }
            break;
        ...
        {
            {
                ...
                else
                {
                    ...
                    for (qsizetype i = 0; i < ValSplit; i++)
                    {
                        PoDoFo::PdfString mUtf8(reinterpret_cast<const PoDoFo::pdf_utf8*>(QString(valDefautquestion.mid(i,1)).toUtf8().constData()));
                        Painter.DrawMultiLineText(PoDoFo::PdfRect(valDebutX + (i * _gap), PageHeight - valDebutY - valHauteur, _gap, valHauteur), mUtf8, mAlignLargeur, mAlignHauteur, false);
                    }
                }
                qDebug() << " effectué";
...
///
/// \brief PDGHelper::GetMaxFontSize    Permet de définit la taille de police adéquate si le texte dépasse de sa zone définie
/// \param Police
/// \param rectWidth
/// \param rectHeight
/// \param mTaillePolice
/// \param Texte
/// \param CorrectionEspace
/// \return
///
double PDGHelper::GetMaxFontSize(PoDoFo::PdfFont*& Police, double rectWidth, double rectHeight, double mTaillePolice, QString Texte, double CorrectionEspace)
{
...
///
/// \brief PDGHelper::RetourneCleStr        Retourne la valeur QSTRING de la clé, si non trouvé, retourne "<!--CleNonTrouve-->"
/// \param lVecKey
/// \param Cle
/// \return
///
...
///
/// \brief PDGHelper::RetourneCleDouble     Retourne la valeur DOUBLE de la clé, si non trouvé, retourne (double)INT16_MAX
/// \param lVecKey
/// \param Cle
/// \return
///
...
///
/// \brief PDGHelper::RetourneCleInt        Retourne la valeur INT de la clé, si non trouvé, retourne INT16_MAX
/// \param lVecKey
/// \param Cle
/// \return
///
...
///
/// \brief PDGHelper::RetourneCleBool       Retourne la valeur BOOL true si la clé existe, sinon retourne false
/// \param lVecKey
/// \param Cle
/// \return
///
