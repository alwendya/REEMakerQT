...
///
/// \brief BlocEditeur::BlocEditeur  Créer un bloc en prenant en entrée les paramètres suivants :
/// \param lPressePapier Pointeur vers le presse papier
/// \param parent QObject du parent du contrôle
/// \param mIDEF ItemDefinition pour peupler le contrôle
/// \param Sombre Le contrôle doit il etre déssiné en mode sombre ?
...
///
/// \brief BlocEditeur::RetourneDonnee Retourne les valeurs du contrôle
/// \return ItemDefinition avec las valeurs du contrôle
///
Bloc::ItemDefinition BlocEditeur::RetourneDonnee()
{
    Update_mItemDef();
...
///
/// \brief BlocEditeur::GetActionQString Convertit en QString le type d'action
/// \param typeAction
/// \return
///
QString BlocEditeur::GetActionQString(Bloc::TypeAction typeAction)
{
...
//qDebug() << "*3" << this->parent()->parent()->parent()->objectName();//groupBox_2
//qDebug() << "*4" << this->parent()->parent()->parent()->parent()->objectName();//tab_6
//qDebug() << "*5" << this->parent()->parent()->parent()->parent()->parent()->objectName();//qt_tabwidget_stackedwidget
//qDebug() << "*6" << this->parent()->parent()->parent()->parent()->parent()->parent()->objectName();//tabWidget
//qDebug() << "*7" << this->parent()->parent()->parent()->parent()->parent()->parent()->parent()->objectName();//centralwidget
//qDebug() << "*8" << this->parent()->parent()->parent()->parent()->parent()->parent()->parent()->parent()->objectName();//MainWindow


///
/// \brief BlocEditeur::ClicBoutonSupprimer     Supprime le bloc actuel
///
void BlocEditeur::ClicBoutonSupprimer()
{
...
///
/// \brief BlocEditeur::ClicBoutonDeplaceHaut   Déplace le bloc actuel vers le haut
///
void BlocEditeur::ClicBoutonDeplaceHaut()
{
    QListWidget* mListWidget = qobject_cast<QListWidget*>(this->parent()->parent());
    auto NomBlocQuestion = this->objectName();
    if (mListWidget->count()> 0)
...
///
/// \brief BlocEditeur::ClicBoutonDeplacePremier    Déplace le bloc actuel au début de la liste
///
void BlocEditeur::ClicBoutonDeplacePremier()
{
    QListWidget* mListWidget = qobject_cast<QListWidget*>(this->parent()->parent());
    auto NomBlocQuestion = this->objectName();
    if (mListWidget->count()> 0)
...
///
/// \brief BlocEditeur::ClicBoutonDeplaceBas    Déplace le bloc actuel vers le bas
///
void BlocEditeur::ClicBoutonDeplaceBas()
{
    QListWidget* mListWidget = qobject_cast<QListWidget*>(this->parent()->parent());
    auto NomBlocQuestion = this->objectName();
    if (mListWidget->count()> 0)
...
///
/// \brief BlocEditeur::ClicBoutonDeplaceFin    Déplace le bloc actuel tout en bas de la liste
///
void BlocEditeur::ClicBoutonDeplaceFin()
{
    QListWidget* mListWidget = qobject_cast<QListWidget*>(this->parent()->parent());
    auto NomBlocQuestion = this->objectName();
    if (mListWidget->count()> 0)
...
///
/// \brief BlocEditeur::ClicBoutonPressePapier  Fait apparaitre le menu du presse-papier pour le bloc actuel
///
void BlocEditeur::ClicBoutonPressePapier()
{
    Update_mItemDef();
    Bloc::ItemDefinition Recopie(*mItemDef);
    ...
    menu->addAction(QIcon(":/Couper"), QString("Couper ce bloc"), this,[this,Recopie](bool){ mPressePapier->AjoutPressePapier(Recopie); ClicBoutonSupprimer();});
...
qint64 BlocEditeur::RetourneIndexLibre()
{
    QListWidget* mListWidget = qobject_cast<QListWidget*>(this->parent()->parent());
...
///
/// \brief BlocEditeur::ClicCheckBoxPrincipale1     Permet de basculer entre texte et checkbox pour la couleur principale
/// \param Etat
///
void BlocEditeur::ClicCheckBoxPrincipale1(bool Etat)
{
    ...
    if (CtrlUtiliseCouleurAccent->isChecked())
        CtrlCouleur->setEnabled(false);
    if((CtrlUtiliseCouleurAccent->isChecked() == false) && (CtrlUtiliseCouleurPrincipale->isChecked() == false) && ((CtrlCouleur->text() == "{ACC 1}") || (CtrlCouleur->text() == "{ACC 2}")))
...
///
/// \brief BlocEditeur::ClicCheckBoxAccent1     Permet de basculer entre texte et checkbox pour la couleur principale
/// \param Etat
///
void BlocEditeur::ClicCheckBoxAccent1(bool Etat)
{
    CtrlCouleur->setEnabled(!Etat);
...
///
/// \brief BlocEditeur::ClicCheckBoxPrincipaleRemplissage   Permet de basculer entre texte et checkbox pour la couleur de remplissage
/// \param Etat
///
void BlocEditeur::ClicCheckBoxPrincipaleRemplissage(bool Etat)
{
    ...
    if (CtrlUtiliseCouleurAccentRemplissage->isChecked())
        CtrlCouleurRemplissage->setEnabled(false);
    if((CtrlUtiliseCouleurAccentRemplissage->isChecked() == false) && (CtrlUtiliseCouleurPrincipaleRemplissage->isChecked() == false) && ((CtrlCouleurRemplissage->text() == "{ACC 1}") || (CtrlCouleurRemplissage->text() == "{ACC 2}")))
...
///
/// \brief BlocEditeur::ClicCheckBoxAccentRemplissage   Permet de basculer entre texte et checkbox pour la couleur de remplissage
/// \param Etat
///
void BlocEditeur::ClicCheckBoxAccentRemplissage(bool Etat)
{
    CtrlCouleurRemplissage->setEnabled(!Etat);
...
///
/// \brief BlocEditeur::Update_mItemDef Mise à jour du pointeur mItemDef avec les contrôles
///
void BlocEditeur::Update_mItemDef()
{
...
///
/// \brief BlocEditeur::PeuplerListe    Peuple la liste avec le contenu du vecteur d'ItemDefinition et affiche à l'écran l'index choisi
/// \param mListe           Handle de la liste
/// \param mVecteur         Vecteur d'itemDefinition
/// \param IndexAAfficher   Index du bloc à rendre visible à la fin
/// \return
///
bool BlocEditeur::PeuplerListe(QListWidget* mListe, QVector<Bloc::ItemDefinition>& mVecteur, qint64 IndexAAfficher)
{
    if (mListe == nullptr)
        return false;
    if (mVecteur.count()==0)
...
///
/// \brief BlocEditeur::AjoutFinListe   Ajoute un bloc à la fin de la liste
/// \param mListe
/// \param mBloc
/// \return
///
bool BlocEditeur::AjoutFinListe(QListWidget* mListe, Bloc::ItemDefinition& mBloc)
{
    if (mListe == nullptr)
        return false;
...
////
/// \brief BlocEditeur::IndexAPartirNomControle    Retourne l'index selon le nom
/// \param mListe
/// \param Nom
/// \return
///
qint64 BlocEditeur::IndexAPartirNomControle(QListWidget* mListe, QString Nom)
{
    if (mListe == nullptr)
        return -1;
    if (Nom == "")
