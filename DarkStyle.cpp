...
void DarkStyle::polish(QPalette& palette) {
    ...
    palette.setColor(QPalette::PlaceholderText, QColor(188, 188, 188, 200));
}
...
void DarkStyle::polish(QApplication* app) {
    ...
    // increase font size for better reading, setPointSize was reduced from +2 because when applied this way in Qt5, the font is larger than intended
    // for some reason
